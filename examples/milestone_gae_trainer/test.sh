...
EXP_NAME="alfworld_milestone_gae_qwen2.5_${MODEL_SIZE}_ood"
...
JUDGE_LLM_URL_1=${JUDGE_LLM_URL_1:-"http://10.102.243.60:8081/v1"}
JUDGE_LLM_URL_2=${JUDGE_LLM_URL_2:-"http://10.102.212.21:8081/v1"}
JUDGE_LLM_MODEL=${JUDGE_LLM_MODEL:-"Qwen3.5-27B-FP8"}
