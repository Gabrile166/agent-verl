#!/usr/bin/env bash
# Reproducible Milestone-GAE training script for SciWorld.
#
# Usage:
#   bash examples/milestone_gae_trainer/run_sciworld.sh [vllm] [hydra overrides...]
...
EXP_NAME="${EXP_NAME:-milestone_gae_qwen2_5_7b_sciworld_l1_seed64}"
PROJECT_NAME="${PROJECT_NAME:-milestone_gae_sciworld}"
...
NUM_CPUS_PER_ENV_WORKER="${NUM_CPUS_PER_ENV_WORKER:-0.15}"
...
MILESTONE_TEMPLATE="${MILESTONE_TEMPLATE:-none}"
